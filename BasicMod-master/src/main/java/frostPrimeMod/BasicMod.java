...
public class BasicMod implements
    ...
    private static final Color cardColor = new Color(123f, 237f, 226f, 1f);
    //red, green, blue, alpha. alpha is transparency, which should just be 1.123, 237, 226
    ...
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new FrostCharacter(),
                CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT, FrostCharacter.Enums.FROST_PRIME);
    }
