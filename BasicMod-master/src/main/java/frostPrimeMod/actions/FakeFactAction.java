...
public class FakeFactAction extends AbstractGameAction {
    public TextureAtlas.AtlasRegion badfish1 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("basicmod/animations/badfish1.png"),0,0,512,512);
    public String[] text = {
            "Fish Fact: ",
            "Fish Fact: "
    };
    ...
    public void update() {
        ...
        AbstractGameEffect fish = new VfxBuilder(badfish1,fishStartX,fishStartY,2f)
