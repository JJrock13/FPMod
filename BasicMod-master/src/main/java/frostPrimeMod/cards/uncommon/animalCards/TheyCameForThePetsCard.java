...
public class TheyCameForThePetsCard extends BaseCard {
    ...
    private final static CardInfo cardInfo = new CardInfo(
            "THEY_CAME_FOR_THE_PETS_CARD", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p, p, new TheyCameForThePetsPower(p, 1)));
