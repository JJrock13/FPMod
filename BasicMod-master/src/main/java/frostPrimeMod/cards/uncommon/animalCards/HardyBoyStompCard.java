...
public class HardyBoyStompCard extends ChooseOneBaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "HARDY_BOY_STOMP_CARD", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        stanceChoices.add(new CrushingStompOption(p, m));
        stanceChoices.add(new BigStompOption(p, m));
