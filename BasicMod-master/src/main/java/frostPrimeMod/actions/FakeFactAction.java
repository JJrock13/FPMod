...
public class FakeFactAction extends AbstractGameAction {
    public TextureAtlas.AtlasRegion badfish1 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("frostPrimeResources/animations/badfish1.png"),0,0,512,512);
    public TextureAtlas.AtlasRegion badfish2 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("frostPrimeResources/animations/badfish2.png"),0,0,512,512);
