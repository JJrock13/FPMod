package frostPrimeMod.frostCharacter;
...
import frostPrimeMod.cards.Basic.FrostDefendCard;
import frostPrimeMod.cards.Basic.FrostStrikeCard;
import frostPrimeMod.cards.Basic.SaveMeHannahCard;
import frostPrimeMod.cards.Basic.SugarGlideCard;
import frostPrimeMod.relics.starter.ActiveStreamerRelic;
...
public class FrostCharacter extends CustomPlayer {
    ...
    //Strings
    private static final String ID = makeID("FrostPrime"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Enums {
        ...
        @SpireEnum
        public static PlayerClass FROST_PRIME;
    ...
    public FrostCharacter() {
        super(NAMES[0], Enums.FROST_PRIME,
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(FrostStrikeCard.ID);
        retVal.add(FrostStrikeCard.ID);
        retVal.add(FrostStrikeCard.ID);
        retVal.add(FrostStrikeCard.ID);
        retVal.add(FrostDefendCard.ID);
        retVal.add(FrostDefendCard.ID);
        retVal.add(FrostDefendCard.ID);
        retVal.add(FrostDefendCard.ID);
        retVal.add(SugarGlideCard.ID);
        retVal.add(SaveMeHannahCard.ID);
        return retVal;
    }
    ...
    public ArrayList<String> getStartingRelics() {
        ...
        retVal.add(ActiveStreamerRelic.ID);
        retVal.add(TwitchStreamerRelic.ID);
        return retVal;
    }
