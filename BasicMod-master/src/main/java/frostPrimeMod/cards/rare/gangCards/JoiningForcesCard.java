...
public class JoiningForcesCard extends BaseCard {
    ...
    private final static CardInfo cardInfo = new CardInfo(
            "JOINING_FORCES_CARD", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p, p, new JoiningForcesPower(p, 1)));
    }
}
