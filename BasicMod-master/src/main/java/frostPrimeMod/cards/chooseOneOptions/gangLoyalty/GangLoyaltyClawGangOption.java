...
public class GangLoyaltyClawGangOption extends DrawSpecificCardsBaseCard {
    ...
    private final static CardInfo cardInfo = new CardInfo(
            "GANG_LOYALTY_CLAW_GANG_OPTION", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public GangLoyaltyClawGangOption() {
        super(cardInfo);
