...
import frostPrimeMod.actions.AndrewAttackAction;
...
public class ANDREWCard extends BaseCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new AndrewAttackAction(p, this.damage, this.magicNumber));
        this.addToBot(new ApplyPowerAction(p, p, new FollowersPower(p, 3)));
        this.addToBot(new GainBlockAction(p, 25));
    }
}
